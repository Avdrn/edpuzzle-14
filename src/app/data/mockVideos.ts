...
export const mockVideos: Video[] = [
  {
    ...
    description:
      "A comprehensive guide to React Hooks and their practical applications in modern web development.",
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Explore modern CSS techniques including Grid, Flexbox, and CSS Variables.",
    thumbnail:
    ...
    questions: [
      {
        timestamp: 300,
        text: "What are the key differences between Grid and Flexbox?",
      },
      {
        timestamp: 540,
        text: "How do you implement responsive layouts with CSS Grid?",
      },
    ],
  },
];
